...
const countries = ['Finland', 'Sweden', 'Norway','India','Pakistan']
...
const B = new Set(b)
const intersectionAB = a.filter((el) => B.has(el))
console.log(intersectionAB)

// Find a minus b
const minusAB = a.filter((el) => !B.has(el))
console.log(minusAB)
...
//   if (langMap.has(lang)){
//     langMap.set(lang,langMap.get(lang)+1)
//     }
//   else{
//     langMap.set(lang,1)
//     }
