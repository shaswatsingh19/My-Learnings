...
console.log('IMPORTANT INTEVIEW QUESTION == SETTIMEOUT WITH CLOSURE')
...
function m(){
    ...
    console.log('this line is run as a normal flow in program but the setTimeout will wait for it particular time and then execute')
}
